...
* Don't remove comments with a TODO in them, unless the TODO has been fixed or is no longer valid.
* For structs and records, use private declaration of members by default, unless pure data containers.
